from API_script import Thema_hydrogen_data_API
import requests
import pandas as pd
import os
...
output_folder = "Thema_API_output/Hydrogen_outlook/"
os.makedirs(output_folder, exist_ok=True)

# initiates an API object of type Thema_hydrogen_data_API
API_object = Thema_hydrogen_data_API(username=username, password=password)
...
json = {
  "scenario": {"Base", "Turbulent transition"},
  "country": "Germany",
  #"edition": "October 2023",
  "group": "CAPEX",
  #"indicator": {"PEM", "Alkaline"},
}
